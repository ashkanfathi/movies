<template>
  <div class="detail_bar">
    <v-btn depressed rounded color="#549DF2" to="/" class="detail_row_button">
    ...
    <div class="detail_row">
      <div class="detail_row_title">{{movieData.title}}</div>
      <div class="detail_row_description">{{movieData.tagline}}</div>
    </div>
  </div>
</template>
